  ...
  --
  -- Host: 127.0.0.1
  -- Generation Time: Dec 10, 2023 at 06:16 AM
  ...
  INSERT INTO `pembelian` (`idpembelian`, `idsupplier`, `idproduk`, `jumlah_pembelian`, `tgl_pembelian`) VALUES
  ...
  (6, 3, 'BRG004', 'Teh Gelas', 1000, 2000, 100, '2023-12-09 07:23:44');
  ...
  INSERT INTO `supplier` (`idsupplier`, `nama_supplier`, `telepon_supplier`, `alamat_supplier`) VALUES
  ...
  ALTER TABLE `laporan`
    ...
    ADD KEY `fk_laporan_pelanggan` (`idpelanggan`);
  ...
  --
  ALTER TABLE `laporan`
    ADD CONSTRAINT `fk_laporan_pelanggan` FOREIGN KEY (`idpelanggan`) REFERENCES `pelanggan` (`idpelanggan`);
